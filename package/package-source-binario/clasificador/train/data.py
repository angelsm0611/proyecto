...
def prepare_data():
    # Obtener el directorio del script actual (dentro de pkg/train/)
    script_dir = os.path.dirname(os.path.abspath(__file__))
    
    # Construir la ruta absoluta a dataset_binario.csv en train/data/
    ...
    try:
        ...
        with open("models/val_data.pkl", "wb") as f:
    ...
    try:
        ...
        torch.save(train_dataset, "models/train_dataset.pt")
        torch.save(val_dataset, "models/val_dataset.pt")
        torch.save(test_dataset, "models/test_dataset.pt")
    except Exception as e:
