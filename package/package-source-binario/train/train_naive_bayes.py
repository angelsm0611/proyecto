...
with mlflow.start_run(run_name=f"Sparse - {model_name}"):
    ...
    try:
        ...
        with open("clasificador/models/naive_bayes_model.pkl", "wb") as f:
            pickle.dump(best_model, f)
        with open("clasificador/models/naive_bayes_val_f1.txt", "w") as f:
            f.write(str(val_f1))
        
        print(f"  Val F1: {val_f1:.3f}, Test F1: {test_f1:.3f}")
        print(f"Modelo guardado como naive_bayes_model.pkl")
